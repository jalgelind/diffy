...
const TokenId TokenId_OpenParen    = 1 << 7;
const TokenId TokenId_CloseParen   = 1 << 8;
const TokenId TokenId_DoubleQuote  = 1 << 9;
const TokenId TokenId_SingleQuote  = 1 << 10;
const TokenId TokenId_Hashtag      = 1 << 11;
const TokenId TokenId_Comma        = 1 << 12;
const TokenId TokenId_Semicolon    = 1 << 13;
const TokenId TokenId_Backslash    = 1 << 14;
const TokenId TokenId_Doubleslash  = 1 << 15;
const TokenId TokenId_Boolean      = 1 << 16;
const TokenId TokenId_Integer      = 1 << 17;
const TokenId TokenId_Float        = 1 << 18;
const TokenId TokenId_String       = 1 << 19;
const TokenId TokenId_Identifier   = 1 << 20;
const TokenId TokenId_Comment      = 1 << 21;
