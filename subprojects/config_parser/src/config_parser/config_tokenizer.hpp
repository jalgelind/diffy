...
const TokenId TokenId_Semicolon    = 1 << 11;
const TokenId TokenId_Backslash    = 1 << 12;
const TokenId TokenId_Doubleslash  = 1 << 13;
const TokenId TokenId_Boolean      = 1 << 14;
const TokenId TokenId_Integer      = 1 << 15;
const TokenId TokenId_Float        = 1 << 16;
const TokenId TokenId_String       = 1 << 17;
const TokenId TokenId_Identifier   = 1 << 18;
const TokenId TokenId_Comment      = 1 << 19;
const TokenId TokenId_Terminator   = 1 << 20;

const TokenId TokenId_FirstOnLine  = 1 << 21; // Only whitespace before this token
