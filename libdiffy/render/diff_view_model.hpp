...
/*
    ...
    semantically-styled text spans — no ANSI escapes, no terminal width, no GUI
    types. Frontends serialise it however they like:
      - the CLI maps SpanStyle -> ANSI (see cli/),
      - the GUI maps SpanStyle -> RGB + font attributes (see gui/diff_bridge).
